      ...
      <v-card-actions>
        ...
        <v-container class="text-center">
          ...
          <v-dialog v-model="dialog7" persistent max-width="400px">
            ...
            <v-card>
              <v-container>
                <v-icon size="60" color="green">mdi-cloud-check-outline</v-icon>
                <br />
                <span class="text-center">Product successfully created</span>
              </v-container>
              <v-card-text> </v-card-text>
              <v-card-actions>
                <v-btn color="blue darken-1" text @click="goBackEdit(dialog7)">
                  Back to edit
                </v-btn>
                <v-spacer></v-spacer>
                <v-btn color="blue darken-1" text @click="dialog7 = false">
                  Add new product
                </v-btn>
              </v-card-actions>
            </v-card>
