<template>
  <v-card height="250" width="900" class="py-2" flat>
    <v-container class="text-start">
      ...
      <v-row class="px-3">
        ...
        >
        <v-spacer></v-spacer>
        <span class="blue--text">+ New template</span>
      </v-row>
    </v-container>
    <v-row>
      <v-col v-for="(item, i) in items" :key="i" class="mx-2">
        <v-card color="#f0f8ff" width="190" height="80">
    ...
    <v-container class="py-0 text-end">
      <span class="blue-grey--text">Show all >></span>
    </v-container>
  </v-card>
</template>
