  ...
  <v-card height="300" width="900" class="py-2" flat>
    <v-container class="text-start">
      ...
      <v-row class="px-3">
        ...
        >
        <v-spacer></v-spacer>
        <span class="blue--text hidden-xs-only">+ New template</span>
      </v-row>
    </v-container>
    <v-row>
      <v-col v-for="(item, i) in items" :key="i" class="mx-2 px-0 " xs="4">
        <v-card
          color="#f0f8ff"
          width="190"
          height="80"
        ...
        >
          <div class="d-flex child-flex justify-space-between">
            <v-row>
              ...
              <v-col cols="1">
                <v-icon color="blue" size="18" @click="showAddTemplate()"
                  >mdi-auto-fix</v-icon
                >
              </v-col>
            </v-row>
      ...
      <v-row>
        <v-col cols="7"></v-col>
        <v-btn outlined style="text-transform:none">Add template</v-btn>
      </v-row>
    </v-row>
    <v-row>
      <v-col cols="10"></v-col>
