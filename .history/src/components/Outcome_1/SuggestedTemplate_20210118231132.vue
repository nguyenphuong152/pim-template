<template>
  <v-card class="text-start" :height="setHeight" flat>
    <v-row class="d-flex align-baseline">
      <v-col cols="7" class="pl-8 blue-grey--text">Suggested template</v-col>
      <v-col class="hidden-md-and-up px-0">
        <v-dialog v-model="dialog4" max-width="270px">
          ...
          <v-card height="100%">
            <v-card-title style="fontSize:18px">
              Suggested Templates
              <v-spacer></v-spacer>
              <v-icon color="red" @click="dialog4 = false"
                ...
                <v-dialog v-model="dialog" max-width="450">
                  <v-card>
                    <v-card-title class="text-start">
                      Your work can be lost!
                    </v-card-title>
                    <v-card-text class="text-start"
                      >Do you want to keep this draft?</v-card-text
                    >
                    <v-card-actions>
                      <v-spacer></v-spacer>
                      <v-btn
      ...
      <v-row class="mx-4 hidden-sm-and-down">
        <v-col cols="3">
          <v-card color="#fafafa" @click="check(name1)" width="150">
        ...
        <v-col cols="3">
          <v-card color="#fafafa" @click="check(name2)" width="150">
            <v-card-text class="black--text font-weight-bold">
              {{ name2 }}
            </v-card-text>
          </v-card>
        ...
        <v-col cols="3">
          <v-card color="#fafafa" @click="check(name3)" width="150">
            <v-card-text class="black--text font-weight-bold">
              {{ name3 }}
            </v-card-text>
          </v-card>
        ...
        <v-col cols="3">
          <v-card color="#fafafa" @click="check(name4)" width="150">
            <v-card-text class="black--text font-weight-bold justify-center">
              {{ name4 }}
            </v-card-text>
          </v-card>
          <v-dialog v-model="dialog3" max-width="450">
