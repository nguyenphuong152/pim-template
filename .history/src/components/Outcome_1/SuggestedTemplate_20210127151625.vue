    ...
    <v-row class="d-flex align-baseline">
      ...
      <v-col class="hidden-md-and-up px-0">
        <v-dialog v-model="dialog4" max-width="270px">
          <template v-slot:activator="{ on, attrs }">
            <v-icon color="#fa4848" v-bind="attrs" v-on="on"
      ...
      <v-row class="mx-4 hidden-sm-and-down">
        <v-col cols="2" class="text-center">
          <v-card color="#fafafa" @click="check(name1)" width="110">
        ...
        <v-col cols="2" class="text-center">
          <v-card color="#fafafa" @click="check(name2)" width="110">
            <v-card-text class="black--text font-weight-bold">
              {{ name2 }}
            </v-card-text>
          </v-card>
        ...
        <v-col cols="2" class="text-center">
          <v-card color="#fafafa" @click="check(name3)" width="110">
            <v-card-text class="black--text font-weight-bold">
              {{ name3 }}
            </v-card-text>
          </v-card>
        ...
        <v-col cols="2" class="text-center">
          <v-card color="#fafafa" @click="check(name4)" width="110">
            <v-card-text class="black--text font-weight-bold ">
              {{ name4 }}
            </v-card-text>
          </v-card>
