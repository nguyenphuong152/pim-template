        ...
        <v-col class="py-0">
          ...
          <v-row class="align-baseline">
            ...
            <v-col cols="3" class="py-0">
              <v-dialog v-model="dialog1" persistent max-width="250px">
          ...
          <v-row class="align-baseline">
            ...
            <v-col cols="3" class="py-0">
              <v-dialog v-model="dialog2" persistent max-width="250px">
                <template v-slot:activator="{ on, attrs }">
                  <v-icon small v-bind="attrs" v-on="on">mdi-pencil</v-icon>
                </template>
                <v-card>
      ...
      <v-container>
        ...
        <v-col class="py-0">
          ...
          <v-row class="align-baseline">
            ...
            <v-col cols="3" class="py-0">
              <v-dialog v-model="dialog4" persistent max-width="250px">
                <template v-slot:activator="{ on, attrs }">
                  <v-icon small v-bind="attrs" v-on="on">mdi-pencil</v-icon>
                </template>
                <v-card>
      ...
      <v-container>
        ...
        <v-col>
          ...
          <v-row class="align-baseline">
            ...
            <v-col cols="3" class="py-0">
              <v-dialog v-model="dialog5" persistent max-width="250px">
                <template v-slot:activator="{ on, attrs }">
                  <v-icon small v-bind="attrs" v-on="on">mdi-pencil</v-icon>
                </template>
                <v-card>
          ...
          <v-row class="align-baseline">
            ...
            <v-col cols="3" class="py-0">
              <v-dialog v-model="dialog6" persistent max-width="250px">
                <template v-slot:activator="{ on, attrs }">
                  <v-icon small v-bind="attrs" v-on="on">mdi-pencil</v-icon>
                </template>
                <v-card>
                  ...
                  <v-card-actions>
                    <v-spacer></v-spacer>
                    <v-btn color="blue darken-1" text @click="dialog6 = false">
                      Close
                    </v-btn>
                    <v-btn color="blue darken-1" text @click="dialog6 = false">
                      Save
        ...
        <v-container class="text-center">
          <v-row>
            ...
            <v-col>
              ...
              <v-dialog v-model="dialog7" persistent max-width="250px">
                <template v-slot:activator="{ on, attrs }">
                  <v-btn
