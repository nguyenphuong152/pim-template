<template>
  <v-card :height="setHeight" width="100%" class="py-2" flat>
    <v-row class="align-baseline mx-1">
      <v-col class="py-0 text-start px-0" cols="3">
        <v-card-title class="font-weight-bold">
          Recent templates
        </v-card-title>
      </v-col>
      <v-col class="px-0 text-start" cols="6">
                    ...
                    <div>
                      <v-row>
                        <v-col class="text-start pl-4">
                          <span
                            class="template-title font-weight-bold black--text pl-5"
                            >{{ item.name }}</span
                          >
                          <br />
