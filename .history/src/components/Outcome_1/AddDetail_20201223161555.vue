<template>
  <v-expansion-panels v-model="pid">
    <v-expansion-panel v-for="(item, i) in this.textComponent" :key="i">
    ...
    <v-expansion-panel v-for="(item, i) in this.imageComponent" :key="i">
      <v-expansion-panel-header disable-icon-rotate value>
        <template v-slot:actions>
          <v-icon color="blue">
            mdi-chevron-down
...
export default {
  computed: {
    ...
    textComponent: function() {
      return this.getListComponent.filter((i) => i.name === "Text");
    },
    imageComponent: function() {
      return this.getListComponent.filter((i) => i.name === "Image");
    },
  },
