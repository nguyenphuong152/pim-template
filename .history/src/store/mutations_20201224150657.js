...
export const CREATE_TEMPLATE = (
  ...
  state.listTemplate.name = name;
  state.listTemplate.basicInfo = basicInfo;
  state.listTemplate.textComponent = textComponent;
  state.listTemplate.imageComponent = imageComponent;
  state.listTemplate.videoComponent = videoComponent;
  state.listTemplate.colorComponent = colorComponent;
  state.listTemplate.dateComponent = dateComponent;
  state.listTemplate.selectComponent = selectComponent;
