  ...
  <v-container class="text-start ma-1 pa-0">
    <v-card flat>
      <v-row class="d-flex align-baseline px-16 pt-4 ">
        <v-col>
          <v-container class="px-16 py-0 hidden-sm-and-down">
            <span class="title ">Basic Information</span>
          </v-container>
        </v-col>
        <v-col>
          <span class="hidden-sm-and-down">Template: {{ templateName }}</span>
        </v-col>
      </v-row>
      <v-container class="py-0 px-md-16">
